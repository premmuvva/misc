# -*- coding: utf-8 -*-
# Generated by Django 1.10 on 2018-10-31 15:40
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('other_invoice_details', models.TextField(blank=True, default='')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer_phone', models.IntegerField(blank=True, default=0)),
                ('customer_email', models.EmailField(blank=True, max_length=70, null=True, unique=True)),
                ('other_customer_details', models.TextField(blank=True, default='')),
                ('customer_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='accounts.UserProfile')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('frequency_description', models.TextField(blank=True, default='')),
            ],
        ),
        migrations.CreateModel(
            name='Suppliers',
